...
def generate_llm_label(
    ...
    prompt = (
        "You are a professional news editor. Create a highly searchable news headline for this topic.\n"
        "The headline must be factual, 3 to 8 words long, and optimized as a query for the Google News Search API.\n"
        "Do not use conversational text, introductory phrases, or symbols. Return ONLY the headline.\n\n"
...
def build_topic_model(
    ...
    seed_topic_list = [
        ...
        ["syed", "suhail", "news", "anchor"],
        ["narendra", "modi", "pm", "modi", "bjp"],
        ["pawan", "khera", "congress", "spokesperson"],
        ["chitra", "tripathi", "news", "anchor"],
        ["rahul", "gandhi", "congress", "leader"],
        ["gaurav", "arya", "major", "defense", "analysis"],
        ["himanta", "biswa", "sarma", "assam", "cm"],
        ["sushant", "sinha", "pathshala", "news"],
        ["mamata", "banerjee", "tmc", "bengal", "election"],
